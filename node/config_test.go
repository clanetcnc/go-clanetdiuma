...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "gcnc.ipc", false, filepath.Join(os.TempDir(), "gcnc.ipc")},
		{"data", "gcnc.ipc", false, "data/gcnc.ipc"},
		{"data", "./gcnc.ipc", false, "./gcnc.ipc"},
		{"data", "/gcnc.ipc", false, "/gcnc.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "gcnc.ipc", true, `\\.\pipe\gcnc.ipc`},
		{"data", "gcnc.ipc", true, `\\.\pipe\gcnc.ipc`},
		{"data", `\\.\pipe\gcnc.ipc`, true, `\\.\pipe\gcnc.ipc`},
	}
