...
|   `puppeth`   | a CLI wizard that aids in creating a new Clanetdium network.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
...
As a developer, sooner rather than later you'll want to start interacting with `gcnc` and the
