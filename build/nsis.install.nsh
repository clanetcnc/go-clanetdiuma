Name "gcnc ${MAJORVERSION}.${MINORVERSION}.${BUILDVERSION}" # VERSION variables set through command line arguments
InstallDir "$InstDir"
OutFile "${OUTPUTFILE}" # set through command line arguments

# Links for "Add/Remove Programs"
!define HELPURL "https://github.com/clanetcnc/go-clanetdiuma/issues"
!define UPDATEURL "https://github.com/clanetcnc/go-clanetdiuma/releases"
!define ABOUTURL "https://github.com/clanetcnc/go-clanetdiuma#ethereum-go"
...
# Install gcnc binary
Section "Gcnc" GETH_IDX
  SetOutPath $INSTDIR
  file {{.Gcnc}}

  # Create start menu launcher
  createDirectory "$SMPROGRAMS\${APPNAME}"
  createShortCut "$SMPROGRAMS\${APPNAME}\${APPNAME}.lnk" "$INSTDIR\gcnc.exe" "--fast" "--cache=512"
  createShortCut "$SMPROGRAMS\${APPNAME}\Attach.lnk" "$INSTDIR\gcnc.exe" "attach" "" ""
  createShortCut "$SMPROGRAMS\${APPNAME}\Uninstall.lnk" "$INSTDIR\uninstall.exe" "" "" ""

  # Firewall - remove rules (if exists)
  SimpleFC::AdvRemoveRule "Gcnc incoming peers (TCP:35410)"
  SimpleFC::AdvRemoveRule "Gcnc outgoing peers (TCP:35410)"
  SimpleFC::AdvRemoveRule "Gcnc UDP discovery (UDP:35410)"

  # Firewall - add rules
  SimpleFC::AdvAddRule "Gcnc incoming peers (TCP:35410)" ""  6 1 1 2147483647 1 "$INSTDIR\gcnc.exe" "" "" "Ethereum" 35410 "" "" ""
  SimpleFC::AdvAddRule "Gcnc outgoing peers (TCP:35410)" ""  6 2 1 2147483647 1 "$INSTDIR\gcnc.exe" "" "" "Ethereum" "" 35410 "" ""
  SimpleFC::AdvAddRule "Gcnc UDP discovery (UDP:35410)" "" 17 2 1 2147483647 1 "$INSTDIR\gcnc.exe" "" "" "Ethereum" "" 35410 "" ""

  # Set default IPC endpoint (https://github.com/ethereum/EIPs/issues/147)
  ${EnvVarUpdate} $0 "ETHEREUM_SOCKET" "R" "HKLM" "\\.\pipe\gcnc.ipc"
  ${EnvVarUpdate} $0 "ETHEREUM_SOCKET" "A" "HKLM" "\\.\pipe\gcnc.ipc"
