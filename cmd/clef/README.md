...
GLOBAL OPTIONS:
   ...
   --keystore value        Directory for the keystore (default: "$HOME/.clanetdium/keystore")
...
The general flow for signing a transaction using e.g. Gcnc is as follows:
![image](sign_flow.png)

In this case, `gcnc` would be started with `--signer http://localhost:8550` and would relay requests to `eth.sendTransaction`.
...
* Another potential thing to introduce is pairing.
  ...
  * Thus Gcnc/cpp would cryptographically handshake and afterwards the caller would be allowed to make signing requests.
  ...
  "params": [
    {
      "accounts": [
        {
          "type": "Account",
          "url": "keystore:///home/bazonk/.clanetdium/keystore/UTC--2017-11-20T14-44-54.089682944Z--123409812340981234098123409812deadbeef42",
          "address": "0x123409812340981234098123409812deadbeef42"
        },
        {
          "type": "Account",
          "url": "keystore:///home/bazonk/.clanetdium/keystore/UTC--2017-11-23T21-59-03.199240693Z--cafebabedeadbeef34098123409812deadbeef42",
